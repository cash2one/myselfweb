; (function($, window, document, undefined) {
    ...
    methods = {
        ...
        add: function(o, $this) {
            ...
            if (o.title != "") {
                $obj.stop().prepend('<div id="HTitle" style="padding:0px 45px 0px 12px;border-bottom:1px solid #ddd;background-color:#f2f2f2;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">' + o.title + "</div>")
            }
