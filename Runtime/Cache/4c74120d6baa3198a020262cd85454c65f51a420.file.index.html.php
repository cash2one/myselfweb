<?php /* Smarty version Smarty-3.1.6, created on 2015-11-04 16:45:39
         compiled from "C:/wamp/www/mymovie/Home/View\Index\index.html" */ ?>
<?php /*%%SmartyHeaderCode:1682056388a95dee518-45599751%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4c74120d6baa3198a020262cd85454c65f51a420' => 
    array (
      0 => 'C:/wamp/www/mymovie/Home/View\\Index\\index.html',
      1 => 1446626738,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1682056388a95dee518-45599751',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_56388a9655652',
  'variables' => 
  array (
    'd' => 0,
    'arr1' => 0,
...
<?php if ($_valid && !is_callable('content_56388a9655652')) {function content_56388a9655652($_smarty_tpl) {?><html lang="en"><head>
	<meta charset="UTF-8">
	<title>找电影</title>
...
<script src="<?php echo @Home_JS;?>
TQ/popModal.js"></script>


</head>
<body>
	<div id="wrapper">
		<div style="background-image: url('<?php echo @Home_IMG;?>
65.jpg');" class="skinBg"></div>
		<header id="header">
			...
			<nav class="headNavs fr tr">
				...
				<a><span class="s-icon s-icon-line"></span></a>
					...
					<?php if ($_smarty_tpl->tpl_vars['d']->value==100){?>
					<a id="popModal_ex1" ><span>用户审核</span></a><a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
...
?>
		<li><?php echo $_smarty_tpl->tpl_vars['k']->value+1;?>
...
' ><span>通过审核</span></a></li>
			...
			<?php } ?>
				...
				<a class="uname" href="<?php echo @__APP__;?>
/Home/manager/logout"><span>退出帐号</span><span class="user-arrow"></span></a>
				<a class="manager" href="javascript:;"><span></span><span class="user-arrow"></span></a>
				<div class="topMenus dn">
					<span class="arrowTop"></span>
				
				</div>
				
					<a id="popModal_ex2" ><span>历史操作记录</span></a><!-- <button id="popModal_ex1">Example</button> -->
...
" style="">•&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $_smarty_tpl->tpl_vars['v']->value['action'];?>
</a></li>
		...
		<div class="content tc">
			<p class="logo"><img width="270" height="129" alt="logo" src="<?php echo @Home_IMG;?>
logo_white.png"></p>
			 <nav class="mainNavs">
				<a href="#"></a>
				<a href="#"></a>
...
jquery.autocomplete.min.js"></script>
