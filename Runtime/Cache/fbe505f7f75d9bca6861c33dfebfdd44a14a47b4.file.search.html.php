<?php /* Smarty version Smarty-3.1.6, created on 2015-05-07 20:38:16
         compiled from "F:/wamp/www/movie/i_movie/Home/View\Index\search.html" */ ?>
<?php /*%%SmartyHeaderCode:12639554a19299e1de0-42751995%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fbe505f7f75d9bca6861c33dfebfdd44a14a47b4' => 
    array (
      0 => 'F:/wamp/www/movie/i_movie/Home/View\\Index\\search.html',
      1 => 1431002055,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12639554a19299e1de0-42751995',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_554a192a179d1',
  'variables' => 
  array (
    'total' => 0,
    'arr' => 0,
...
<?php if ($_valid && !is_callable('content_554a192a179d1')) {function content_554a192a179d1($_smarty_tpl) {?><!DOCTYPE html>
...
/Index/index ><img src=<?php echo @Home_IMG;?>
ret.png>
				</div>
			...
			<div class="movielist">
				<div class="pagepre">
					<p>
						共找到<span><?php echo @$_smarty_tpl->tpl_vars['total']->value;?>
</span>个视频
					</p>
				</div>
				<ul class="mlist"><?php  $_smarty_tpl->tpl_vars['v'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['v']->_loop = false;
...
/Index/show/id/<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
 ...
 class="p" target="_blank"><img
							src="http://localhost/movie/i_movie/public/<?php echo $_smarty_tpl->tpl_vars['v']->value['sf_pic'];?>
" alt=""><em>超清</em></a>
					<div class="info">
							<h2>
								<a href=<?php echo @__MODULE__;?>
/Index/show/id/<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
 ...
 target="_blank"><?php echo $_smarty_tpl->tpl_vars['v']->value['name'];?>
							...
							<p><i>地区：<?php echo $_smarty_tpl->tpl_vars['v']->value['areaname'];?>
</i></p>
							<p>
								<i>类型：<?php echo $_smarty_tpl->tpl_vars['v']->value['catename'];?>
</i>
							</p>
							<p>
								<i>演员：<?php echo $_smarty_tpl->tpl_vars['v']->value['actor'];?>
</i>
							</p>
