...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_570241daad46b',
  'has_nocache_code' => false,
  'cache_lifetime' => 3600,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_570241daad46b')) {function content_570241daad46b($_smarty_tpl) {?>﻿<!DOCTYPE html>
<html>	
<head>
<title>Login</title>
	...
	if(keyword==1){
		...
		if($("#username").val()==""||$("#email").val()==""||$("#password").val()==""){
			...
			$.ajax({
  			...
  			success: function(){
  				alert("注册成功");
  				$('.login-form').children().remove();
			$(".login-form").html('<div class="avtar"><img src="../../../public/Home/img/avtar.png" /></div><form method="post" action="/index.php/Home/index/login"><input type="hidden" id="keyword"name="keyword" class="text" value="1"/><input type="text" class="text" id="username" name="username" value="" /><div class="key"><input type="password" id="password" name="password" value="" /></div><div class="signin"><input type="submit" id="btn"  value="登陆" /></div></form>');
		...
		if($("#username").val()==""||$("#password").val()==""){
			...
			$.ajax({
  			...
  			success: function(){
  				alert("登陆成功");
  				//window.location.href="/index.php/Home/index/persional_homepage";
  			},
  			error: function(){
  				alert("登陆失败");
  			},
...
<div class="login-form1">
		...
		<div class="head-info">
			...
			<label class="lbl-3" style="padding-top: 3px; padding-left: 3px; "><p align='center' style="padding-top: 3px; padding-right: 2px;"><a href="/index.php/Home/index/qqconnect" ><img src="../../../public/Home/img/Connect_logo_1.png"/></a></p> </label>
		</div>
		</div>
<div class="login-form" style="margin-top: 0px;">			
	<div class="avtar">
		<img src="../../../public/Home/img/avtar.png" />
	</div>
